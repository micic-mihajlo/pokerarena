...
* All code, comments, identifiers (variable names, function names, type names, etc.), commit messages, and content within Markdown code blocks: use **English** entirely, no Chinese characters allowed.
* In Markdown documents: body text uses Chinese, all content within code blocks uses English.
